...
public class PeerServer {
	...
	//public String CIS_ip = "10.0.0.13";       //============>IP-address of the IndexServer has to be specified here
	public String CIS_ip = "localhost";       //============>IP-address of the IndexServer has to be specified here
	...
	public PeerServer() {
		...
		System.out.println("||========================================================================================||");
		System.out.println("||                           PEER-TO-PEER FILE SHARING SYSTEM    (MENU)                   ||");
		System.out.println("||========================================================================================||");
		...
		while (true){
			...
			if (regmessage.equals("1")){
				...
				System.out.println("Enter the String(in Format 4-Digit id and File Names separated by Space): ");
				//	Scanner in = new Scanner(System.in);  
				regmessage = in.nextLine();
	...
	public void RegisterWithIServer()                             //Register with IndexServer Method
	{
		try{
			//1. Creating a socket to connect to the server
			requestSocket = new Socket(CIS_ip, 2001);
			System.out.println("\nConnected to Register on IndexServer on port 2001\n");
	...
	public void SearchWithIServer()                              //Search on the CentralIndexServer Method
	{
		try{
			...
			System.out.println("\nConnected to Search on IndexServer on port 2002\n");
			//2. To Get Input and Output streams
			out = new ObjectOutputStream(requestSocket.getOutputStream());
			out.flush();			
